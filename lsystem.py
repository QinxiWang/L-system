...
#the LSystem constructor takes a list of strings as its argument, where each string is a single rule.
...
#-------------Two cases Implementations---------------#
   show_demo("1",Qinxi1demo)
   #show_demo("2",Qinxi2demo)
...
def initDisplay(drawColour="tomato"):
    setup()
    reset()
    degrees()
    color(drawColour)
